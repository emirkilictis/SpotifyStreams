...
const FORCE_CANONICAL = {
  ...
  // (Re-verified 2026-07-10 against live stream_stats: 1QonoQ0/712SSg=18.87M
  // match ErrTime original 05eNOCd=18.87M, NOT standalone Latto 5Cansk=14.75M;
  // 6CbbaIF=4.26M matches Jeezy&Latto cluster 2NvQGd=4.26M, NOT standalone
  // Jeezy 1dtdgZ=1.18M. Gemini's re-add reverted for the second time.)
